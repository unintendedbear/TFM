...
When all the experiments were finished, we went for a step beyond, and realised that some of the connections were made trough the Squid proxy, thus in those cases, the entries were almost the same, but \ac{IP}s changed. Consequently, new files were generated.
...
\caption{\label{tab_stats1} Statistics of the files created from the initial file of unbalanced data. It can be seen that after the partition, the ratio between allows and denies remains the same.}
\end{table}
...
\caption{\label{tab_stats2} Statistics of the files created after the \textbf{undersampling} technique was applied. It can be seen that after the partition, the ratio between allows and denies remains the same, and they are not unbalanced.}
\end{table}
...
\caption{\label{tab_stats3} Statistics of the files created after the \textbf{oversampling} technique was applied. It can be seen that after the partition, the ratio between allows and denies remains the same, and they are not unbalanced.}
\end{table}
