...
The Thesis is structured as follows. Next Chapter (Chapter \ref{cap2:SotA}) describes the state of the art about applications or devices related to \ac{BYOD} being adopted by companies, and protection of the users' privacy. Also, it described related work with regard to the application of Data Mining and Machine Learning techniques to security issues inside a company and, finally, introduces some work review about the study of \ac{URL}s and its use for security menaces detection.
