...
\figuraEx{Vectorial/samsung_knox.pdf}{width=1.\textwidth}{fig:img_knox_01}%
...
\figuraEx{Vectorial/Blackberry_balance.pdf}{width=1.\textwidth}{fig:blackberry_bal}%
...
%-------------------------------------------------------------------
\label{cap2:sec:tools:subsec:blackp}
...
% METER LO DEL ESTUDIO DE LAS URL
